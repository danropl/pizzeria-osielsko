...
const pizzas: Pizza[] = [
  { name: "Margherita", ingredients: "sos pomidorowy San Marzano, mozzarella fior di latte, świeża bazylia, oliwa EV", price: "[CENA]", badge: "Klasyczna", badgeColor: "bg-accent/80 text-accent-foreground", placeholder: "Pizza Margherita", image: margheritaImg },
  { name: "Pepperoni", ingredients: "sos pomidorowy, mozzarella, pikantne pepperoni, oregano", price: "[CENA]", badge: "Bestseller 🔥", badgeColor: "bg-primary/80 text-primary-foreground", placeholder: "Pizza Pepperoni", image: pepperoniImg },
  { name: "Quattro Formaggi", ingredients: "mozzarella, gorgonzola, parmezan, ricotta, miód truflowy", price: "[CENA]", badge: "Nowość ✨", badgeColor: "bg-yellow-500/80 text-white", placeholder: "Pizza Quattro Formaggi", image: quattroFormaggiImg },
  ...
  { name: "Diavola", ingredients: "sos pomidorowy, mozzarella, nduja, salami piccante, papryczki chili", price: "[CENA]", badge: "Ostre 🌶️🌶️", badgeColor: "bg-red-500/80 text-white", placeholder: "Pizza Diavola", image: diavolaImg },
  ...
  { name: "Funghi Porcini", ingredients: "biała baza śmietanowa, mozzarella, grzyby porcini, czosnek, tymianek, truflowe olio", price: "[CENA]", badge: "Premium 👑", badgeColor: "bg-yellow-600/80 text-white", placeholder: "Pizza Funghi Porcini", image: funghiPorciniImg },
  { name: "Bambino", ingredients: "sos pomidorowy, mozzarella, szynka gotowana, kukurydza", price: "[CENA]", badge: "Dla dzieci 👶", badgeColor: "bg-accent/80 text-accent-foreground", placeholder: "Pizza Bambino", image: bambinoImg },
  { name: "Vegetariana", ingredients: "sos pomidorowy, mozzarella, papryka, cukinia, bakłażan, rukola, pomidorki", price: "[CENA]", badge: "Vege 🌱", badgeColor: "bg-accent/80 text-accent-foreground", placeholder: "Pizza Vegetariana", image: vegetarianaImg },
  { name: "Pizza del Giorno", ingredients: "zmieniają się codziennie — sezonowe propozycje szefa kuchni", price: "[CENA]", badge: "Sezonowa 🍂", badgeColor: "bg-orange-500/80 text-white", placeholder: "Pizza del Giorno", image: pizzaDelGiornoImg },
];
